...
\urlstyle{same}
\hypersetup{
  pdftitle={Vor der Antwort},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{\protect\phantomsection\label{_s0a7ddwuqehv}{}Vor der Antwort}
\usepackage{etoolbox}
\makeatletter
...
\makeatother
\subtitle{\protect\phantomsection\label{_o9ks49jgkq76}{}Vorgeschichte zur Trilogie ``Die letzte Freiheit''}
\author{}
\date{}
